            ...
            <div className="p-8 lg:w-1/2 mx-auto">
                ...
                <div className="bg-gray-100 rounded-b-lg py-36 px-4 lg:px-24">
                    <p className="text-center text-sm text-gray-500 font-light">
                        <p className='text-[#363636] font-medium'>Or sign in with credentials</p>
                        <p className='font-semibold text-xl text-[#363636]'>Don't have an Account? <Link to={"/register"}><span className='text-[#5a55ca] font-bold hover:underline cursor-pointer'>Register</span></Link></p>
                    </p>
                    <form onSubmit={handleLogin} className="mt-6">
                        ...
                        <div className="flex items-center justify-center mt-8">
                            <button className="block w-full max-w-xs mx-auto bg-[#5a55ca] hover:bg-white border-2 border-[#5a55ca] text-white hover:text-[#5a55ca] hover:border-2 hover:border-[#5a55ca] font-bold rounded-lg px-3 py-3">SIGN IN</button>
                        </div>
                    </form>
                </div>
            </div>
